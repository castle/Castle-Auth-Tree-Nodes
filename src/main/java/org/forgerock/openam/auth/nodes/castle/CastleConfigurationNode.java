...
public class CastleConfigurationNode extends SingleOutcomeNode {
    private final CastleService config;
    ...
    @Inject
    public CastleConfigurationNode(@Assisted CastleService config) {
        this.config = config;
    }
